...
import 'package:mysalonapp_flutter/screen/Newlostscreen.dart';
import 'package:mysalonapp_flutter/screen/SendMasseges.dart';
import 'package:mysalonapp_flutter/screen/client_Screen.dart';
import 'package:mysalonapp_flutter/screen/create_client.dart';
                ...
                decoration: InputDecoration(
                  prefixIcon: Row(
                    ...
                    children: [
                      ...
                      Icon(CupertinoIcons.person_2,color: Colors.black,size: 30,),
                      SizedBox(
                        width: 10,
                      ),
                      Center(child: Text(' Clients',style: TextStyle(color: Colors.black,fontSize: 25,fontWeight: FontWeight.bold),))
                    ],
                  ),
                  filled: true,
                ...
                children: [
                  Container(
                      ...
                      child: ListView(padding: EdgeInsets.all(16),
                        children: [
                          _buildListItem('Lost Clients  ',CupertinoIcons.person_2,() {Get.to(Newlostscreen());},),
                          _buildListItem('Client Comment', CupertinoIcons.captions_bubble, () {
                          },),
                          _buildListItem('Client List', Icons.checklist_rtl, () {},),
                          _buildListItem('create A New Client', CupertinoIcons.person_add_solid, () {
                            Get.to(Sendmasseges());
                          },),
                        ],)
                  ),
