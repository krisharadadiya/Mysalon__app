...
import 'package:mysalonapp_flutter/screen/Settings.dart';
import 'package:mysalonapp_flutter/screen/client_Screen.dart';
import 'package:mysalonapp_flutter/screen/edit_client.dart';
import 'package:mysalonapp_flutter/screen/sendseclaction.dart';
import 'package:mysalonapp_flutter/utile/path/image_string_path.dart';

class Sendmasseges extends StatelessWidget {
  const Sendmasseges({super.key});
                ...
                decoration: InputDecoration(
                  prefixIcon: Row(
                    ...
                    children: [
                      ...
                      Center(child: Text('Send Messages',style: TextStyle(color: Colors.black,fontSize: 25,fontWeight: FontWeight.bold),))
                    ],
                  ),
                  filled: true,
                ...
                children: [
                  Container(
                      ...
                      child: ListView(padding: EdgeInsets.all(16),
                        children: [
                          _buildListItem('Message Settings', Icons.settings_outlined, () {
                            Get.to(Settings());
                          },),
                          _Star('Message Reports', Icons.line_weight_sharp, () {},),
                          _buildListItem('Send Section', Icons.mail_outline, () {
                            Get.to(Onlinechatscreen(name: 'krisha', lastMessage: 'krisha', photoUrl: 'assets/image/profesional2.jpg'));
                          },),
                          _buildListItem('view Template', Icons.list_alt_outlined, () {},),
                          _buildListItem('Send Massage To Groups', CupertinoIcons.person_3_fill, () {},),
                          _buildListItem('Craete Message To Groups', CupertinoIcons.group_solid, () {},),
                          _buildListItem('Message Blacklist', CupertinoIcons.nosign, () {},),
                        ],)
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
