...
import 'package:mysalonapp_flutter/screen/clientlist_click_screen.dart';
import 'package:mysalonapp_flutter/screen/edit_client.dart';
import 'package:mysalonapp_flutter/screen/employee_list_screen.dart';
                ...
                decoration: InputDecoration(
                  prefixIcon: Row(
                    ...
                    children: [
                      ...
                      Center(child: Text('Lists',style: TextStyle(color: Colors.black,fontSize: 25,fontWeight: FontWeight.bold),))
                    ],
                  ),
                  filled: true,
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      child: ListView(padding: EdgeInsets.all(16),
                        children: [
                          _buildListItem('Client List',() {
                          },),
                          _buildListItem('Employe List',() {
                            Get.to(EmployeeListScreen());
                          },),
                          _buildListItem(' Treatment List',() {
                            Get.to(ClientScreen());
                          },)
                        ],)
                  ),
