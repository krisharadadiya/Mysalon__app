                ...
                decoration: InputDecoration(
                  prefixIcon: Row(
                    ...
                    children: [
                      ...
                      Icon(CupertinoIcons.pencil_ellipsis_rectangle,color: Colors.black,size: 30,),
                      SizedBox(
                        width: 10,
                      ),
                      Center(child: Text('Create A New Treatment',style: TextStyle(color: Colors.black,fontSize: 25,fontWeight: FontWeight.bold),))
                    ],
                  ),
                  filled: true,
                ...
                children: [
                  Container(
                      ...
                      child: ListView(padding: EdgeInsets.all(16),
                        children: [
                          _Star('Create A New Treatment', CupertinoIcons.pencil_ellipsis_rectangle, () {
                          },),
                          _buildListItem('Add Bulk Treatment  ',CupertinoIcons.pencil_ellipsis_rectangle,() {},),
                          _buildListItem('Create Treatmnet Request', CupertinoIcons.add_circled, () {
                          },),
                          _buildListItem('Treatment request', CupertinoIcons.add_circled, () {},),
                        ],)
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
