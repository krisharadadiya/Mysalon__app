...
class Newlostscreen extends StatelessWidget {
  const Newlostscreen({super.key});
                ...
                decoration: InputDecoration(
                  prefixIcon: Row(
                    ...
                    children: [
                      ...
                      Center(child: Text(' Lost Client',style: TextStyle(color: Colors.black,fontSize: 25,fontWeight: FontWeight.bold),))
                    ],
                  ),
                  filled: true,
                ...
                children: [
                  Container(
                      ...
                      child: ListView(padding: EdgeInsets.all(16),
                        children: [
                          _buildListItem('User 1  ',CupertinoIcons.person_2,() {},),
                          _buildListItem('User 2', CupertinoIcons.person_2, () {
                          },),
                          _buildListItem('User 3 ', CupertinoIcons.person_2, () {},),
                          _buildListItem('user 4', CupertinoIcons.person_2, () {
