...
import 'package:mysalonapp_flutter/screen/branch_list_screen.dart';
                ...
                decoration: InputDecoration(
                  prefixIcon: Row(
                    ...
                    children: [
                      ...
                      Icon(CupertinoIcons.question_circle,color: Colors.black,size: 30,),
                      SizedBox(
                        width: 10,
                      ),
                      Center(child: Text('Supports',style: TextStyle(color: Colors.black,fontSize: 25,fontWeight: FontWeight.bold),))
                    ],
                  ),
                  filled: true,
                ...
                children: [
                  Container(
                      ...
                      child: ListView(padding: EdgeInsets.all(16),
                        children: [
                          _buildListItem('Operating Settings', CupertinoIcons.question_circle, () {
                            Get.to(BranchListScreen());
                          },),
                          _buildListItem('Gallery Management',  Icons.call, () {},),
                        ],)
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
