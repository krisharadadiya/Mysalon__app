                ...
                decoration: InputDecoration(
                  prefixIcon: Row(
                    ...
                    children: [
                      ...
                      Center(child: Text(' Treatmnet LIst',style: TextStyle(color: Colors.black,fontSize: 25,fontWeight: FontWeight.bold),))
                    ],
                  ),
                  filled: true,
                ...
                children: [
                  Container(
                      ...
                      child: ListView(padding: EdgeInsets.all(16),
                        children: [
                          _buildListItem('Treatment List', Icons.checklist_rtl, () {},),
                          _Star('Creates A New Treatment ', CupertinoIcons.pencil_ellipsis_rectangle, () {
                          },),
                        ],)
                  ),
                  Row(
