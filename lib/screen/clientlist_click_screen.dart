...
class ClientlistClickScreen extends StatelessWidget {
  const ClientlistClickScreen({super.key});
                ...
                decoration: InputDecoration(
                  prefixIcon: Row(
                    ...
                    children: [
                      ...
                      Icon(Icons.checklist_rounded,color: Colors.black,size: 30,),
                      SizedBox(
                        width: 10,
                      ),
                      Center(child: Text(' Client List',style: TextStyle(color: Colors.black,fontSize: 25,fontWeight: FontWeight.bold),))
                    ],
                  ),
                  filled: true,
                  ...
                  Container(
                      ...
                      child: ListView(padding: EdgeInsets.all(16),
                        children: [
                          ...
                          _Star('Inactive Client List', Icons.checklist_rounded, () {

                          },),
                          _buildListItem('Lost Clients  ',CupertinoIcons.person_2_fill,() {},),
                        ],)
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
