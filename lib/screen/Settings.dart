...
import 'package:mysalonapp_flutter/screen/Supports.dart';
                ...
                decoration: InputDecoration(
                  prefixIcon: Row(
                    ...
                    children: [
                      ...
                      Center(child: Text('Settings',style: TextStyle(color: Colors.black,fontSize: 25,fontWeight: FontWeight.bold),))
                    ],
                  ),
                  filled: true,
                ...
                children: [
                  Container(
                      ...
                      child: ListView(padding: EdgeInsets.all(16),
                        children: [
                          _buildListItem('Operating Settings', Icons.settings_outlined, () {
                            Get.to(Supports());
                          },),
                          _buildListItem('Gallery Management',  Icons.filter, () {},),
                          _buildListItem('Platform Settings', Icons.settings_outlined, () {},),
                          _buildListItem('System Records', Icons.file_copy, () {},),
                          _buildListItem('English', Icons.language, () {},),
                          _buildListItem('Delete My Account', Icons.delete, () {},),
                        ],)
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
